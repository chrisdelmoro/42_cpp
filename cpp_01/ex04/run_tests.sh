...
# Test 1
echo -e "\nTest 1"
./bin/sadsed tests/no_matches.txt match replacement
if [ $? -eq 0 ]; then
...
# Test 2
echo -e "\nTest 2"
./bin/sadsed tests/one_match_per_line.txt match "word match"
if [ $? -eq 0 ]; then
...
# Test 3
echo -e "\nTest 3"
./bin/sadsed tests/multiple_matches.txt dance sway
if [ $? -eq 0 ]; then
...
# Test 4
echo -e "\nTest 4"
./bin/sadsed tests/numbers.txt 5 Z
if [ $? -eq 0 ]; then
...
# Test 5
echo -e "\nTest 5"
./bin/sadsed tests/special_chars.txt "$" "\"*
\""
if [ $? -eq 0 ]; then
